...
- **Backend Repo Link**: https://github.com/Data-Block1010/backendnew
- **Smart Contract Repo Link**: https://github.com/Data-Block1010/soroban-contract
...
SecureData DApp is a decentralized application (DApp) built using Next.js and Shadcn, designed for secure e-identity management and data verification. This DApp empowers users to securely store, verify, and manage their identity documents and sensitive data in a decentralized, user-controlled environment. Utilizing the Stellar network, Soroban smart contracts, and Zero-Knowledge (zk) proofs, SecureData ensures enhanced privacy, security, and autonomy over users' data.
...
- **Identity Storage:**
  Secure storage of identity documents like passports, driver's licenses, and other identification on Stellar via a Soroban smart contract to ensure a tamper-proof environment.

- **Identity Verification:**
  A Soroban data-verification contract validates the authenticity of identity documents, employing Zero-Knowledge (zk) proofs to securely verify documents without revealing sensitive data.
...
- **Data Hashing:**
  Hashes of sensitive data (e.g., personal and financial records) are stored on Stellar via Soroban to create a secure and immutable record.

- **Data Verification:**
  The Soroban data-verification contract ensures that the stored data has not been altered, maintaining data integrity. Zero-Knowledge (zk) proofs allow third parties to verify the authenticity of documents without having direct access to the data itself.
...
- **Immutable Records:**
  Stellar's ledger ensures that all data is immutable, preserving data integrity.
...
- **Stellar / Soroban:** Decentralized, scalable, and tamper-proof on-chain storage and access control for data, via Soroban smart contracts.
...
- **Soroban Data-Storage Contract:** Smart contract for verifying identity and sensitive data, see [soroban-contract](https://github.com/Data-Block1010/soroban-contract).
